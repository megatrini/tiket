...
echo"<br>";
$objpnp = new tiketkai();
$objpnp ->setNamaLengkap("Maulana Yusuf Abdullah<br>");
...
$objtik ->tanggal = "05 SEPTEMBER 2020<br>";
$objtik ->Booking();
echo"<br><br/>";
...
$objborpas ->nama = "Maulana Yusuf Abdullah<br>";
...
$objborpas ->depart = "PASAR SENEN(PSE), 05 SEPT 2020, 09.15 WIB<br>";
$objborpas ->tiba = "TASIKMALAYA(TSM), 05 SEPT 2020, 16.48 WIB<br>";
$objborpas ->Eticket();
?>